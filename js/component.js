        ...
        if (ele.classList.contains("active")) {
          if (ele.classList.contains("datepicker-tbl-wrap")) {
            if (e.classList.contains("range")) {
              contsHeight =
                ele.querySelector(".datepicker-tbl").offsetHeight +
                ele.querySelector(".datepicker-btn-wrap").offsetHeight;
            } else {
  ...
  closeSingle: () => {
    ...
    cal.forEach((e) => {
      ...
      if (colConts.classList.contains("single")) {
        const calBtn = colConts.querySelectorAll(
          ".datepicker-tbl .btn-set-date"
        );
        calBtn.forEach((ele) => {
          ele.addEventListener("click", () => {
            kds_datepicker.close();
...
const quickNav = {
  ...
  navHighlight: () => {
    ...
    if (quickIndicators.length > 0) {
      ...
      const firstSecTop = document.querySelectorAll(
        ".scroll-check .section-link"
      )[0].offsetTop;
      sectionArea.forEach((current) => {
        ...
        if (scrollY <= firstSecTop) {
          ...
          document
            .querySelector(
              ".conts-area > .quick-nav-area .quick-list li:first-of-type a"
            )
          ...
          document
            .querySelector(
              ".conts-area > .quick-nav-area .quick-list li:last-of-type a"
            )
            .classList.add("active");
        } else {
          if (scrollY > sectionTop && scrollY <= sectionTop + sectionHeight) {
            ...
            document
              .querySelector(
                ".conts-area > .quick-nav-area a[href*=" + sectionId + "]"
              )
              .classList.add("active");
          } else {
            document
